...
data.table::fwrite(h %>% filter(total_doses>10), paste0(nsnp_dir,"allhaplotype_stats_b1_morethan10.txt"), row.names = F, quote = F, sep = "\t")
#BLOCK 2
...
data.table::fwrite(h %>% filter(total_doses>10), paste0(nsnp_dir,"allhaplotype_stats_b2_morethan10.txt"), row.names = F, quote = F, sep = "\t")
#Block 3
...
data.table::fwrite(h %>% filter(total_doses>10), paste0(nsnp_dir,"allhaplotype_stats_b3_morethan10.txt"), row.names = F, quote = F, sep = "\t")
