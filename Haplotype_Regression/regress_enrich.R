...
ggplot(allstats, aes(fill=basechange))+facet_wrap(~block,scales="free_x")+
  ...
  theme_classic()+theme(legend.position="top",axis.text.x=element_text(angle=45,vjust=0.5,hjust=0.5),axis.title=element_text(size=20),
                        legend.text=element_text(size=20),
                        legend.title=element_text(size=18))
ggsave(paste0(fdir,"snps",nsnp,"/figures_askout07012024/diseaseburdenbar.tiff"),height=10,width=12)
